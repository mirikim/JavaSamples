...
public class ScoreEvaluation {
	...
	static void displayRecord() {
		...
		+ Student2.format(koreanTotal + "", 11, Student2.CENTER)
				+ Student2.format(englishTotal + "", 6, Student2.CENTER)
				+ Student2.format(mathTotal + "", 6, Student2.CENTER) 
				+ Student2.format(total + "", 8, Student2.CENTER));
...
class NameAscending implements Comparator {//comparable 기본정렬 //comparator 임의의 정렬 구현 
...
// 총점을 내림차순(큰값에서 작은값)으로 정렬하는데 사용되는 클래스
